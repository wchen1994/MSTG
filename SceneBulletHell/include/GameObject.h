...
public:
	static std::shared_ptr<GameObject> Create(
		GameObject* const parent, const sf::Vector2f & pos, const CommResMeth::Angle & rot, const char *objName);
public: // Constructor Destructor
    GameObject();
	GameObject(GameObject* const parent, const sf::Vector2f & pos, const CommResMeth::Angle & rot, const char *objName);
	~GameObject();

...
std::shared_ptr<GameObject> GameObject::Create(GameObject * const parent, const sf::Vector2f & pos, const CommResMeth::Angle & rot, const char * objName)
{
...
GameObject::GameObject(GameObject* const parent, const sf::Vector2f & pos, const CommResMeth::Angle & rot, const char *objName) :
	Moveable(pos, rot),
	unique_id(++uniqueIdCounter),
	parent(parent)
{
